...
parcelas = int(input('Qualtas vezes vc quer parcelar?: '))
prestação = valor_casa / (parcelas *12)
minimo = salario *30 / 100
print('Para pagar uma casa de R${:.2f} e {} anos, á prestação será de R${:.2f}'.format(valor_casa, parcelas, prestação))
if prestação <=minimo:
